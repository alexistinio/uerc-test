...
<div class="card text-start py-3 px-3 mb-3 mt-3 shadow" style="border: none">
                    <div style="line-height: normal">
                        ...
                        <h3 class="pt-1" style="font-family: 'Inter Tight', sans-serif;">{{ __('Edit Board Member') }}</h3>
        ...
        <div class="col-md-12">
            <div class="card shadow" style="border: none">
                ...
                <form id="selectform" method="POST" action="/board_member/update/{{ $board_member->id }}">
                        @csrf
                        @method('PUT')
                    <div class="px-md-3">
                        <div class="row">
                      ...
                      <input type="hidden" name="id" value="{{ $board_member->id }}">
                        <div class="row mb-3">
                            <div class="col-md-2">
                            <select name="title" class="form-select @error('title') is-invalid @enderror" id="title" autocomplete="title" autofocus>
                            ...
                            <?php 
                            echo "<script>document.getElementById('title').value = '$board_member->title'</script>"
                            ?>
                            @error('title')
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-4">
                                ...
                                <input id="firstname" type="text" placeholder="John" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ $board_member->firstname }}" autocomplete="firstname" autofocus>
                            ...
                            <div class="col-lg-4 mb-4">         
                                ...
                                <input id="lastname" type="text" placeholder="Doe" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ $board_member->lastname }}" autocomplete="lastname" autofocus>
                             ...
                             <div class="col-lg-4 mb-4">
                                ...
                                <input style="width: 20%" id="initial" type="text" maxlength="1" placeholder="C" class="form-control @error('initial') is-invalid @enderror" name="initial" value="{{ $board_member->initial }}" autocomplete="initial" autofocus>
                       ...
                       <select data-style="btn-outline-dark" name="position" class="form-select @error('position') is-invalid @enderror" id="position" autocomplete="position">
                        ...
                        <?php 
                         echo "<script>document.getElementById('position').value = '$board_member->position'</script>"
                        ?>
                         @error('position')
                                   <span class="invalid-feedback" role="alert">
                                       <strong>{{ $message }}</strong>
                         ...
                         @enderror
                            ...
                            <div class="col-lg-4 mb-4 mt-lg-0 mt-3">
                                    ...
                                    <input id="email" type="email" placeholder="example@gmail.com" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $board_member->email }}" autocomplete="email">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input id="phone_number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                            maxlength = "11" type="number" maxNumber="2" placeholder="093989*****" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ $board_member->phone_number }}" autocomplete="phone_number">
