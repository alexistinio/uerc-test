...
<head>
    ...
    <title>ACKNOWLEDGEMENT RECEIPT OF REPORT</title>
<style>
    body{
...
<body>
 <div class="content">
    ...
    <div class="container-b pt-4 px-4 mx-5">
            <h1 style="font-size: 16px" class="text-center fw-bold">ACKNOWLEDGEMENT RECEIPT OF REPORT</h1>
            <div class="mt-3">{{ date('M d, Y', strtotime($protocols->date_of_receipt)) }}</div>
            <div class="mt-3">{{ $protocols->p_researcher }}</div>
            <div>{{ Auth::user()->role=='Admin' ? 'UERC' : Auth::user()->colleges }}</div>
            ...
            <div class="mt-3">Relative to the study protocol with the title, “{{ $protocols->title }}” with the code {{ $protocols->protocol_code }}, {{ Auth::user()->role=='Admin' ? 'UERC' : Auth::user()->colleges }} acknowledges the receipt of</div>
            <div class="container">
            <div class="row">
                <div class="col" style="line-height: 130%;">
                    <input class="mt-2" type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
                ...
                <div class="col" style="line-height: 130%;">
                    <input class="mt-2" type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
                    <label for="vehicle1">SAE Report</label><br> 
                </div>
            </div>
            <div class="row">
                <div class="col" style="line-height: 130%;">
                    <input class="mt-2" type="checkbox" id="vehicle1" name="vehicle1" value="Bike">
                    <label for="vehicle1">SUSAR Report</label>
                </div>
            </div>
            <div class="row">
                <div class="col" style="line-height: 130%;">
            ...
            <div class="mt-3">on {{ date('M d, Y', strtotime($protocols->date_of_receipt)) }}.</div>
        ...
        <div class="container-f d-flex justify-content-between" style="margin-top: 60px">
            <div style="font-size: 12px">F-CRD-UERC Form No.018 Acknowledgement Receipt of Reports Form</div>
