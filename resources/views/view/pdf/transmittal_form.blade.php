    ...
    <div class="container-b pt-4 px-4 mx-5">
        <div class="row">
            <div class="col offset-4">
             <div style="font-size: 16px" class="fw-bold text-center">UERC Transmittal Form</div>
            </div>
            ...
            <div class="container border border-dark">
                <div class="row">
                    <div class="col">
                        <div class="pb-3 fw-bold">Title:</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col pb-2" style="border-width: 1px 1px 0 0; border-color: black; border-style: solid;">
                ...
                <div class="row">
                    <div class="col" style="border-width: 1px 1px 0 0; border-color: black; border-style: solid;">
                        <div class="fw-bold">Principal Investigator (PI):</div>
                        <div class="fw-bold">Email:</div>
                    </div>
                    <div class="col" style="border-top: 1px solid black">
                        <div class="fw-bold">Mobile Number:</div>
        ...
        <div class="container-f d-flex justify-content-between" style="margin-top: 70px">
            <div style="font-size: 12px">F-CRD-UERC Form No 023  Transmittal Form</div>
