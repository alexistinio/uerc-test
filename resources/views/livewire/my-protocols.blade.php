...
<body>
    ...
    <div class="card py-1 mt-3 border border-0 shadow-lg">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col ms-3 ms-md-0 ms-lg-2">
            <div class="ps-2">
         ...
         @else
          ...
          <button id="upload_protocol" data-bs-toggle="modal" data-bs-target="#modal_1" class="btn btn-primary py-2 mt-3 mt-sm-0">Upload Protocol 
      ...
      <ul class="dropdown-menu py-3">
        <li class="mb-2">
          <a class="dropdown-item" style="background-color: silver" href="/protocol_management/myprotocols">
            My Protocols
          </a>
        </li>
        <li>
          <a class="dropdown-item" href="/administrator" id="uploadBtn">
            Admin Access
          </a>
        ...
        @endif
              ...
              <div class="ps-3 mt-3 d-none d-lg-flex" style="overflow: hidden;">
                  <div onclick="myProtocolType_function()" class="{{ $protocol=='all' && Auth::user()->role=='Admin' ? 'active' : '' }} p-2" style="cursor: pointer; background-color: <?php echo $protocol=='all' && Auth::user()->role!='Admin' ? '#e6e6e6' : '' ?>; border-radius: 10px">All Protocols</div>
                    ...
                    <div onclick="ongoing_function()" class="{{ $protocol=='ongoing' && Auth::user()->role=='Admin' ? 'active' : '' }} ms-3 p-2" style="cursor: pointer; background-color: <?php echo $protocol=='ongoing' && Auth::user()->role!='Admin' ? '#e6e6e6' : '' ?>; border-radius: 10px">On-going</div>
    ...
    @if(Auth::user()->role=="Admin")
      ...
      @endif
        ...
        @if($protocol=='firstDecision')
        <div class="col-1 text-end" id="controlsHide">
            <a href="/myprotocols" class="btn btn-dark d-none d-xl-block">Reset</a>
        </div>
        @endif
   

    <div class="col-12 col-lg-3 mt-2 mt-lg-0<?php echo $protocol=='firstDecision' ? 'mt-2' : '' ?>" id="torDiv">
        ...
        <div class="col-4 col-lg-2 mt-2 mt-lg-0<?php echo $protocol=='firstDecision' ? 'mt-2' : '' ?>" id="sortDiv">
            <div>
        ...
        @if($protocol!='firstDecision')
        <div class="col-1 text-end" id="controlsHide">
            <a href="/protocol_management/myprotocols" class="btn btn-dark d-none d-xl-block">Reset</a>
        </div>
        @endif
    ...
    <div class="col-3" id="torDiv">
        ...
        <div class="col text-end" id="controlsHide">
            <a href="/protocol_management/myprotocols" class="btn btn-dark">Reset</a>
        </div>
